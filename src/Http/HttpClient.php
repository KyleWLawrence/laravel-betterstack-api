...
namespace KyleWLawrence\BetterStack\Http;

use GuzzleHttp\Client;
use GuzzleHttp\Exception\RequestException;
use GuzzleHttp\HandlerStack;
use KyleWLawrence\BetterStack\Exceptions\AuthException;
use KyleWLawrence\BetterStack\Http\Middleware\RetryHandler;
use KyleWLawrence\BetterStack\Http\Resources\Send;
use KyleWLawrence\BetterStack\Utilities\Auth;
...
class HttpClient
{
    ...
    public function __construct(
        protected string $hostname = 'uptime.betterstack.com',
        ...
        $this->apiUrl = "$this->scheme://$this->hostname/$this->base/";
    ...
    {
        return 'BetterStack API PHP '.self::VERSION;
    }
     ...
     *
     * @throws \KyleWLawrence\BetterStack\Http\Exceptions\AuthException
     * @throws \KyleWLawrence\BetterStack\Http\Exceptions\ApiResponseException
     */
